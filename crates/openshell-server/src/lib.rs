...
async fn build_compute_runtime(
    ...
    match driver {
        ComputeDriverKind::Kubernetes => {
            ...
            k8s.ssh_handshake_secret
                .clone_from(&config.ssh_handshake_secret);
            k8s.ssh_handshake_skew_secs = config.ssh_handshake_skew_secs;
        ...
        ComputeDriverKind::Podman => {
            ...
            podman
                ...
                .clone_from(&config.ssh_handshake_secret);
            podman.ssh_handshake_skew_secs = config.ssh_handshake_skew_secs;
